<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editmobilemessage.aspx.cs" Inherits="MobileCms.editmobilemessage" %>
...
<body>
        ...
        <div class="primary_right">
            <div class="inner">
                ...
                <div class="content ps">
                    ...
                    <form id="editMobileMessageForm" name="editMobileMessageForm" method="post" action="">
                            ...
                            <tr>
                                ...
                                <td width="90%">
                                    <div class="out">
                                        ...
                                        <input type="text" id="content" name="content" class="left" value="<%=content%>" />
    ...
    <script type="text/javascript">
        var mobileMessageId = '<%=strId%>';

        $(function () {
            $("#editMobileMessageForm").resetForm();

            $.formValidator.initConfig({
                formid: "editMobileMessageForm",
                submitbuttonid: "editMobileMessageFormSub",
                validatorgroup: "1",
                errorfocus: true,
                onerror: function () {
                    return false;
        ...
        function initListboxRemoveAndListboxAdd() {
            $.ajax({
                url: "/Ajax/getremoveandaddmobilemessagehtmloptions.ashx?id=" + mobileMessageId,
                type: "POST",
                async: false,
                dataType: "text",
        ...
        function save() {
            ...
            $("#editMobileMessageForm").ajaxSubmit({
                url: "/Ajax/editmobilemessage.ashx",
