...
namespace MobileCms
{
    public partial class mobileappwhitelist : BasePageMember
    {
        ...
        private void GetList(MobileUser mobileUser, string userName)
        {
            ...
            DataTable dt = mobileAppService.GetListByPage(mobileUser.CompanyCode, userName, "WhiteList", start, limit, out total);
