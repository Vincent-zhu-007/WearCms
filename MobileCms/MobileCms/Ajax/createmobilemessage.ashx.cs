...
{
    /// <summary>
    /// Summary description for createmobilemessage
    /// </summary>
    public class createmobilemessage : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (mobileUser != null)
            {
                ...
                string result = mobileMessageService.CreateMobileMessageFromServer(companyCode, ownerUri, targetUris, content);
