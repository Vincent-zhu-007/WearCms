...
{
    /// <summary>
    /// Summary description for lockmobile
    /// </summary>
    public class lockmobile : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (mobileUser != null)
            {
                ...
                string result = mobileUserService.LockMobileFromServer(mobileUser.CompanyCode, id);
