<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mobileappwhitelist.aspx.cs" Inherits="MobileCms.mobileappwhitelist" %>
...
<body>
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="" href="javascript:;" onclick="openMobileAppWhiteListItem('<%#Eval("Id")%>');">查看应用</a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
    ...
    <script type="text/javascript">
        function openMobileAppWhiteListItem(id) {
            var timestamp = new Date().getTime();
            location.href = "mobileappwhitelistitem.aspx?id=" + id + "&t=" + timestamp;
        }
    </script>
</body>
</html>
