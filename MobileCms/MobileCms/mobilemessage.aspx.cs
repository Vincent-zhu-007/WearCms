...
namespace MobileCms
{
    public partial class mobilemessage : BasePageMember
    {
        ...
        private void GetList(MobileUser mobileUser, string userName)
        {
            ...
            DataTable dt = mobileMessageService.GetListByPage(mobileUser.CompanyCode, userName, start, limit, out total);
