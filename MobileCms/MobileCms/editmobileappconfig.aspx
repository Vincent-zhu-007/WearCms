<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editmobileappconfig.aspx.cs" Inherits="MobileCms.editmobileappconfig" %>
...
<body>
        ...
        <div class="primary_right">
            <div class="inner">
                ...
                <div class="content ps">
                    ...
                    <form id="editMobileAppConfigForm" name="editMobileAppConfigForm" method="post" action="">
                        <table class="table add" width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td width="72%">
                                    <div class="out">
                                        ...
                                        <input type="text" id="description" name="description" class="left" value="<%=description%>" />
                            ...
                            <tr>
                                ...
                                <td width="72%">
                                    <div class="out">
                                        <input type="text" id="packageName" name="packageName" class="left" value="<%=packageName%>" />
                                        <span class="left">*</span>
    ...
    <script type="text/javascript">
        $(function () {
            $("#editMobileAppConfigForm").resetForm();

            $.formValidator.initConfig({
                formid: "editMobileAppConfigForm",
                submitbuttonid: "editMobileAppConfigFormSub",
                validatorgroup: "1",
                errorfocus: true,
                onerror: function () {
                    return false;
        ...
        function save() {
            $("#editMobileAppConfigForm").ajaxSubmit({
                url: "/Ajax/editmobileappconfig.ashx",
