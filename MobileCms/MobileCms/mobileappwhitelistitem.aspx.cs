...
namespace MobileCms
{
    public partial class mobileappwhitelistitem : BasePageMember
    {
        ...
        private void GetList(MobileUser mobileUser, string description)
        {
            ...
            if (mobileApp != null)
            {
                ...
                DataTable dt = mobileAppItemService.GetListByPage(description, listFileName, start, limit, out total);
