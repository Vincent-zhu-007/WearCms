<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="whitelistmember.aspx.cs" Inherits="MobileCms.whitelistmember" %>
...
<body>
                    ...
                    <div class="title">
                        <form runat="server" id="queryForm" name="queryForm" method="post" action="">
                            ...
                            <div class="queryform_btn btn">
                                ...
                                <a href="/createwhitelistbyhand.aspx?id=<%=mobileContactId%>">
                                    <span>增加</span>
                                </a>
                            ...
                            <asp:Repeater ID="rptList" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%#Eval("NumButton")%></td>
                                        <td>
                                            <a class="" href="javascript:;" onclick="editWhiteListMember('<%#Eval("Id")%>');">编辑</a>
                                            &nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        function editWhiteListMember(id) {
            location.href = "editwhitelistmember.aspx?id=" + id;
        }
    </script>
</body>
</html>
