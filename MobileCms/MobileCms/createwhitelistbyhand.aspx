<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createwhitelistbyhand.aspx.cs" Inherits="MobileCms.createwhitelistbyhand" %>
                    ...
                    <form id="createMobileContactMemberForm" name="createMobileContactMemberForm" method="post" action="">
                        <table class="table add" width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                ...
                                <td width="72%">
                                    <div class="out">
                                        <input type="text" id="shortNum" name="shortNum" class="left" value="" />
    ...
    <script type="text/javascript">
        ...
        function save() {
            $("#createMobileContactMemberForm").ajaxSubmit({
                url: "/Ajax/createwhitelistmemberbyhand.ashx",
